...
add_action( 'admin_menu', 'pcs_add_options_page' );
...
register_activation_hook( PSC_PLUGIN_FILE, 'psc_activation' );
register_deactivation_hook( PSC_PLUGIN_FILE, 'psc_daily_event' );
